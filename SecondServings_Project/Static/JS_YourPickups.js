...
document.getElementById("user_name").value = post.getUserName();
document.getElementById("expiration_date2").value = post2.getExpiration().toLocaleDateString();
document.getElementById("user_name2").value = post2.getUserName();
document.getElementById("expiration_date3").value = post3.getExpiration().toLocaleDateString();
document.getElementById("user_name3").value = post3.getUserName();
